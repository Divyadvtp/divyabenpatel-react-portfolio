export default function Education({ pageRefs }) {
  return (
    <section
      id="education-section"
      className="education-flex-container"
      ref={(el) => (pageRefs.current = { ...pageRefs.current, education: el })}
    >
      ...
      <div className="grid-container">
        <div className="grid-item">
          <p>2022 Sep - 2023 Aug</p>
          <p><strong>Computer Applications Development (CO-OP)</strong></p>
          <p>Conestoga College</p>
          <p><strong>GPA</strong> - 3.89</p>
        </div>
        <div className="grid-item">
          <p>2022 Jan - 2022 Aug</p>
          <p><strong>Software Quality Assurance and Test Engineering</strong></p>
          <p>Conestoga College</p>
          <p><strong>GPA</strong> - 3.80</p>
        </div>
        <div className="grid-item">
          <p>2012 Jun - 2016 jun</p>
          <p><strong>Bachelor of Engineering in Computer Science</strong></p>
          <p>RNG Patel Institute of Technology (Formerly, FETR)</p>
          <p><strong>GPA</strong> - 3.48</p>
        </div>
      </div>
    </section>
  );
