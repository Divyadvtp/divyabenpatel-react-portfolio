  ...
  return (
    <footer id="footer" className="footer-container" ref={el => pageRefs.current = { ...pageRefs.current, footer: el }}>
      <div className="inner-content">
        ...
        <div className="copyright inner-item">&copy;Copyright 2024.
          <div> Made by <a className="footerName" rel="noreferrer" target="_blank" href="https://divyadvtp.github.io/divyabenpatel-react-portfolio/">Divyaben Patel</a></div>
        </div>
